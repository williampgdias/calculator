...
for(let i = 0; i < number.length; i++) {
    number[i].addEventListener('click', function(e) {
        ...
        if(resultDisplayed === false) {
            ...
            // if result is currently displayed and user pressed number
...
for(let i = 0; i < operator.length; i++) {
    ...
    if(lastChar === "+" || lastChar === "-" || lastChar === "x" || lastChar === "÷") {
        ...
        // if first key pressed is an operator, do not do anything
...
result.addEventListener('click', function() {
    ...
    // this is the string that we will be processing eg.
    let inputString = input.innerHTML

    // forming and array of numbers. eg for above string it will be: numbers = ["10", "26", "33", "56", "34", "23"]
    ...
    // as we move we are alterning the original numbersa and operators array
    // the final element remaining in the array will be output
